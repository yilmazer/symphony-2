...
class Gateway
{
     ...
     * @param string $forceconnection_method
     ...
     */
    public function exec($forceconnection_method = null)
    {
        if ($forceconnection_method != self::FORCE_SOCKET && self::isCurlAvailable()) {
            $ch = curl_init();
