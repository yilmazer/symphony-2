...
class XSLTProcess
{
    ...
    {
        return (class_exists('XSLTProcessor') || function_exists('xsltprocess'));
    }
     ...
     *
     * @see toolkit.XSLTProcess#error()
     * @see toolkit.XSLTProcess#process()
     * @param string $xml
     *  The XML for the transformation to be applied to
     * @param string $xsl
     *  The XSL for the transformation
     ...
     * @return string
     */
    private function runProcess(XSLTProcessor $XSLProc, $xml, $xsl, array $parameters = array())
    {
    ...
    {
        $this->error($errno, str_replace('DOMDocument::', null, $errstr), $errfile, $errline, 'xml');
    }
    ...
    {
        $this->error($errno, str_replace('DOMDocument::', null, $errstr), $errfile, $errline, 'xsl');
    }
    ...
    {
        $this->error($errno, str_replace('DOMDocument::', null, $errstr), $errfile, $errline, 'xsd');
    }
     ...
     */
    public function error($number, $message, $file = null, $line = null, $type = null)
    {
        $context = null;
