...
class PageManager
{
    ...
    {
        return Symphony::Database()->fetchCol(
            'type',
            sprintf(
                "SELECT
                    type
    ...
    {
        return (boolean)Symphony::Database()->fetchRow(
            0,
            sprintf(
                "SELECT
                    pt.id
    ...
    {
        $path = array();
        $page = Symphony::Database()->fetchRow(
            0,
            sprintf(
                "SELECT
                    p.%s,
        ...
        if (!is_null($page['parent'])) {
            ...
            while ($parent = Symphony::Database()->fetchRow(
                0,
                sprintf(
                    "SELECT
                        p.%s,
    ...
    {
        return Symphony::Database()->fetchRow(
            0,
            sprintf(
