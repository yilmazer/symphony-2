...
class Widget
{
            ...
            if (isset($o['label'])) {
                ...
                foreach ($o['options'] as $option) {
                    $optgroup->appendChild(
                        Widget::selectBuildOption($option)
                    );
                }

                $obj->appendChild($optgroup);
            } else {
                $obj->appendChild(Widget::selectBuildOption($o));
            }
        }
     ...
     * @return XMLElement
     */
    private static function selectBuildOption($option)
    {
    ...
    public static function Apply(array $options = null)
    {
        ...
        $fieldset->appendChild(new XMLElement('button', tr('Apply'), array('name' => 'action[apply]', 'type' => 'submit')));
