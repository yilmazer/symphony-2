...
class Mutex
{
    ...
    {
        return touch(self::generateLockFileName($id, $path));
    }
     ...
     * @return string
     */
    private static function generateLockFileName($id, $path = null)
    {
        ...
        if (!is_array(self::$lockFiles)) {
            ...
            register_shutdown_function(array(__CLASS__, 'shutdownCleanup'));
        }
     ...
     */
    public static function shutdownCleanup()
    {
        $now = time();
