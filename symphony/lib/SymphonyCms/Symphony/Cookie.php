...
use \SymphonyCms\Symphony\Session;
...
class Cookie
{
     ...
     * function. It creates a new Session object via the `$this->init()`
     *
     * @see init()
    ...
    private function init()
    {
        ...
        // Class FrontendPage uses $_COOKIE directly (inside it's buildPage() function), so try to emulate it.
